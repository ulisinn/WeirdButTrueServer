...
const CATEGORIES = require('./all_questions_spanish/Categories.json');
const ANIMAL_FACTS = require('./all_questions_spanish/AnimalFacts.json');
const FOOD_FACTS = require('./all_questions_spanish/FoodFacts.json');
const HUMAN_FACTS = require('./all_questions_spanish/HumanFacts.json');
const INSECT_FACTS = require('./all_questions_spanish/InsectFacts.json');
const MISC_FACTS = require('./all_questions_spanish/MiscellaneousFacts.json');
const OUTER_SPACE_FACTS = require('./all_questions_spanish/OuterSpaceFacts.json');
const PLANT_FACTS = require('./all_questions_spanish/PlantFacts.json');
const SEA_WATER_FACTS = require('./all_questions_spanish/SeaWaterFacts.json');
const SPORTS_FACTS = require('./all_questions_spanish/SportsFacts.json');
const TECHNOLOGY_FACTS = require('./all_questions_spanish/TechnologyFacts.json');
const VEHICLE_FACTS = require('./all_questions_spanish/VehicleFacts.json');
const WEATHER_FACTS = require('./all_questions_spanish/WeatherFacts.json');
